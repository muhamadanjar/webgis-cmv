...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('dist/css/framework7.ios.min.css') }}">
  ...
  <body>
    ...
    <script type="text/javascript" src="{{ url('dist/js/framework7.min.js')}}"></script>
    <!-- Path to your app js-->
    <script type="text/javascript" src="{{ url('dist/js/my-app.js')}}"></script>
  </body>
</html>